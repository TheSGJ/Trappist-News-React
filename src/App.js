    ...
    return (
      ...
      />
          ...
          <div className="App grid place-items-center" id="App">
            <Routes>
              <Route path="/" element={<Home setProgress={this.setProgress} apiKey={this.apiKey}  pageSize={this.pageSize} key="general" category="general" country="in"/>} />
              {/* start categories */}
              ...
              <Route path="/popular-blogs" element={<PopularBlogs setProgress={this.setProgress} per_page={5}/>}/>
            </Routes>
          </div>
        </Router>
      </div>
